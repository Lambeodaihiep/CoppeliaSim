...
if (clientID>-1)
    ...
    [returnCode]=sim.simxSetJointTargetVelocity(clientID,left_Motor,10,sim.simx_opmode_blocking);
    [returnCode]=sim.simxSetJointTargetVelocity(clientID,right_Motor,10,sim.simx_opmode_blocking);
    %end
